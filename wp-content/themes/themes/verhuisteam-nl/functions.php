    ...
    <div style="padding:28px 16px;">
        <div style="max-width:640px;margin:0 auto;background:#ffffff;border:1px solid #e5e7eb;border-radius:10px;overflow:hidden;">
            <div style="padding:22px 26px;background:#2f5f80;color:#ffffff;">
                <p style="margin:0 0 6px;font-size:13px;font-weight:700;letter-spacing:.02em;text-transform:uppercase;">Verhuisteam.nl</p>
...
add_action('wp_enqueue_scripts', function () {
    ...
    if (file_exists(get_stylesheet_directory() . '/css/buttons.css')) {
        wp_enqueue_style('verhuisteam-buttons', get_stylesheet_directory_uri() . '/css/buttons.css', ['child-style'], filemtime(get_stylesheet_directory() . '/css/buttons.css'));
    }

    // Header CSS
    if (file_exists(get_stylesheet_directory() . '/css/header.css')) {
        wp_enqueue_style('verhuisteam-header', get_stylesheet_directory_uri() . '/css/header.css', ['child-style'], filemtime(get_stylesheet_directory() . '/css/header.css'));
    }
    ...
    if (is_page_template(['page-landing.php', 'page-opdracht-landingspagina.php']) && file_exists(get_stylesheet_directory() . '/css/landing.css')) {
        wp_enqueue_style('verhuisteam-landing', get_stylesheet_directory_uri() . '/css/landing.css', ['child-style'], filemtime(get_stylesheet_directory() . '/css/landing.css'));
    }
    ...
    if (is_page_template('page-werkgever.php') && file_exists(get_stylesheet_directory() . '/css/landing-werkgever.css')) {
        wp_enqueue_style('verhuisteam-landing-werkgever', get_stylesheet_directory_uri() . '/css/landing-werkgever.css', ['child-style'], filemtime(get_stylesheet_directory() . '/css/landing-werkgever.css'));
    }
    ...
    if (is_page_template('page-werkzoekende.php') && file_exists(get_stylesheet_directory() . '/css/landing-werkzoekende.css')) {
        wp_enqueue_style('verhuisteam-landing-werkzoekende', get_stylesheet_directory_uri() . '/css/landing-werkzoekende.css', ['child-style'], filemtime(get_stylesheet_directory() . '/css/landing-werkzoekende.css'));
    }
    ...
    if (is_page_template('page-split-hero.php') && file_exists(get_stylesheet_directory() . '/css/split-hero.css')) {
        wp_enqueue_style('verhuisteam-split-hero', get_stylesheet_directory_uri() . '/css/split-hero.css', ['child-style'], filemtime(get_stylesheet_directory() . '/css/split-hero.css'));
    }

    // Homepage hero CSS
    if (file_exists(get_stylesheet_directory() . '/css/hero-homepage.css')) {
        wp_enqueue_style('verhuisteam-hero', get_stylesheet_directory_uri() . '/css/hero-homepage.css', ['child-style'], filemtime(get_stylesheet_directory() . '/css/hero-homepage.css'));
    }
...
add_action('init', function () {
    ...
    register_taxonomy('job_tag', 'job_listing', [
        'labels' => [
            'name'          => __('Job Tags', 'verhuisteam'),
            'singular_name' => __('Job Tag', 'verhuisteam'),
            'all_items'     => __('All Tags', 'verhuisteam'),
            'add_new_item'  => __('Add New Tag', 'verhuisteam'),
            'edit_item'     => __('Edit Tag', 'verhuisteam'),
        ],
        'hierarchical'      => false,
        'show_ui'           => true,
        'show_admin_column' => true,
