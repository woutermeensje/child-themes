...
$contact_email  = get_post_meta($page_id, 'hero_email', true) ?: 'support@verhuisteam.nl';
?>

<section class="welcome-v2">
    <header class="welcome-v2__hero welcome-v2__hero--freelancer-inhuren" aria-label="Introductie Verhuisteam.nl">
        ...
        <div class="welcome-v2__hero-left">
            <div class="welcome-v2__hero-content">
                ...
                <div class="welcome-v2__hero-copy">
                    ...
                    <?php else : ?>
                        <p class="welcome-v2__lead">Ben je op zoek naar personeel of zoek je opdrachten en projecten? Het team van Verhuisteam.nl helpt jou verder!</p>
                    <?php endif; ?>

                    <div class="welcome-v2__actions">
                        <a href="https://platform.verhuisteam.nl/" target="_blank" rel="noopener" class="si-btn si-btn--accent" style="font-family: 'Work Sans', sans-serif !important; font-weight: 700 !important;">Ik zoek werk</a>
