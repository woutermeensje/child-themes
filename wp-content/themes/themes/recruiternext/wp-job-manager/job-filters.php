...
<form class="job_filters">
    ...
    <div class="filter-header" style="padding: 0 20px 10px 20px;">
        <h2>Bekijk alle Recruitment Vacatures & Opdrachten</h2>
        <p>
            Of schrijf je in voor de <a href="https://recruiternext.nl/nieuwsbrief/" target="_blank" class="unstyled-newsletter-link">nieuwsbrief!</a>!
        </p>
    </div>
