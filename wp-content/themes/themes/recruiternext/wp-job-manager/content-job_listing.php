 ...
 *
 * Fondsen-style template adapted for Recruiternext.
 */
...
$company_logo_html = get_the_post_thumbnail($post_id, 'thumbnail');
    ...
    <div class="job-card" data-href="<?php the_job_permalink(); ?>">
        <div class="job-card__desktop">
            ...
            <div class="job-card__content">
                <?php if (function_exists('sj_the_job_favorite_button')) : ?>
...
.job-card__logo-badge--placeholder {
    ...
    border-color: rgba(4, 88, 171, 0.35);
