 ...
 *
 * Gebaseerd op de sustainablejobs-nl kaart, aangepast voor recruiternext.
 */
                ...
                <div class="job_listing_content">
                    ...
                    <div class="jobs_buttons_wrap">
                        <div class="jobs_buttons">
                            ...
                            <a href="<?php echo esc_url(get_permalink($post_id) . '#rn-vraag'); ?>" class="jobs_buttons__contact" onclick="event.stopPropagation();">Contact opnemen</a>
                        </div>
                    </div>
                </div>
...
(function () {
    ...
    if (window.__rnJobCardClick) return;
    window.__rnJobCardClick = true;
