...
$eyebrow         = get_post_meta($page_id, 'landing_eyebrow', true)               ?: 'Voor organisaties die recruitment talent zoeken';
$intro           = has_excerpt($page_id) ? get_the_excerpt($page_id)              : 'Recruiternext.nl is dé vacaturesite voor recruitment en HR professionals. Plaats jouw vacature en bereik direct de juiste kandidaten.';
...
$contact_email   = get_post_meta($page_id, 'landing_email', true) ?: 'support@recruiternext.nl';
?>
