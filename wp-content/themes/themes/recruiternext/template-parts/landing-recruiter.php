...
$intro           = has_excerpt($page_id) ? get_the_excerpt($page_id)              : 'Recruiternext.nl biedt recruitment bureaus de mogelijkheid om hun vacatures te presenteren aan recruitment en HR professionals door heel Nederland.';
