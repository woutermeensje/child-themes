...
$intro           = has_excerpt($page_id) ? get_the_excerpt($page_id)              : 'Recruiternext.nl is dé vacaturesite voor recruitment en HR professionals. Ontdek de nieuwste vacatures en zet de volgende stap in jouw carrière.';
...
$secondary_label = get_post_meta($page_id, 'landing_secondary_button_text', true) ?: 'Alle Vacatures';
