<?php
/**
 * Blog overzichtspagina — Recruiternext child theme
 *
 * Layout:
...
$img_icon = '<svg xmlns="http://www.w3.org/2000/svg" width="80" height="80" viewBox="0 0 24 24" fill="none" stroke="#0458ab" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="18" rx="2"/><path d="m3 9 4-4 4 4 4-4 4 4"/><circle cx="8.5" cy="14.5" r="1.5"/><path d="m21 15-5-5-5 5"/></svg>';

$zoekterm = '';
if ( isset( $_GET['rn_s'] ) ) {
    $raw_zoekterm = wp_unslash( $_GET['rn_s'] );
    $zoekterm     = is_array( $raw_zoekterm ) ? '' : sanitize_text_field( $raw_zoekterm );
}
    ...
    <?php else : ?>
        ...
        <div class="sj-blog__heroes">
            ...
            <?php if ( $hero_main ) :
                ...
                $auteur  = function_exists( 'rn_get_article_author' ) ? rn_get_article_author( $hero_main->ID ) : get_post_meta( $hero_main->ID, '_rn_artikel_auteur', true );
            ?>
            ...
            <div class="sj-blog__heroes-side">
                <?php foreach ( $hero_side as $post ) :
                    ...
                    $auteur  = function_exists( 'rn_get_article_author' ) ? rn_get_article_author( $post->ID ) : get_post_meta( $post->ID, '_rn_artikel_auteur', true );
                ?>
            ...
            <aside class="sj-blog__sidebar">
                ...
                <div class="sj-sidebar-newsletter">
                    <div class="sj-sidebar-newsletter__body">
                        ...
                        <h3 class="sj-sidebar-newsletter__title">Recruitmentnieuws en vacatures direct in je inbox</h3>
                ...
                <div class="sj-sidebar-links">
                    <a href="/vacature-plaatsen/" class="sj-sidebar-link">
                        ...
                        <span class="sj-sidebar-link__text">
                            ...
                            <span>Bereik recruitment en HR professionals</span>
                        </span>
                    ...
                    <a href="/job-alerts/" class="sj-sidebar-link">
                        <span class="sj-sidebar-link__icon" aria-hidden="true">
                        ...
                        <span class="sj-sidebar-link__text">
                            <strong>Vacature alert</strong>
                            <span>Ontvang nieuwe recruitment vacatures</span>
                        </span>
                        <svg class="sj-sidebar-link__arrow" xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M3 10a.75.75 0 0 1 .75-.75h10.638L10.23 5.29a.75.75 0 1 1 1.04-1.08l5.5 5.25a.75.75 0 0 1 0 1.08l-5.5 5.25a.75.75 0 1 1-1.04-1.08l4.158-3.96H3.75A.75.75 0 0 1 3 10Z" clip-rule="evenodd"/></svg>
                    </a>
                </div>
