<?php
/**
 * Single blogpost — Recruiternext child theme
 *
...
<?php
    ...
    $auteur    = function_exists( 'rn_get_article_author' ) ? rn_get_article_author( get_the_ID() ) : get_post_meta( get_the_ID(), '_rn_artikel_auteur', true );
...
<div class="sj-single__wrap">
    ...
    <aside class="sj-single__sidebar">
        ...
        <div class="sj-single__recent">
            <h3 class="sj-single__recent-title">Recente artikelen</h3>
            <?php
            $recent = new WP_Query( [
                'post_type'      => 'post',
                'posts_per_page' => 6,
                ...
                <div class="sj-recent__img-wrap">
                    ...
                    <?php else : ?>
                        <div class="sj-recent__img-placeholder">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="#0458ab" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="18" rx="2"/><path d="m3 9 4-4 4 4 4-4 4 4"/><circle cx="8.5" cy="14.5" r="1.5"/><path d="m21 15-5-5-5 5"/></svg>
                        </div>
                    <?php endif; ?>
                </div>
