...
$eyebrow        = get_post_meta( $page_id, 'hero_eyebrow', true ) ?: 'Lansingerland Fit';

$bg_style = $hero_image_url ? ' style="background-image: url(\'' . esc_url( $hero_image_url ) . '\');"' : '';
?>

<section class="lf-hero-home" aria-label="Introductie Lansingerland Fit">
    ...
    <div class="lf-hero-home__inner">
        ...
        <div class="lf-hero-home__actions">
            <a href="<?php echo esc_url( home_url( '/gratis-proefles/' ) ); ?>" class="lf-hero-home__btn lf-hero-home__btn--primary">Gratis proefles</a>
            <a href="<?php echo esc_url( home_url( '/lesrooster/' ) ); ?>" class="lf-hero-home__btn lf-hero-home__btn--outline">Lesrooster</a>
        </div>
    </div>
