...
// Search the banner image by name in the media library.
$banner_posts = get_posts([
    'post_type'      => 'attachment',
    'post_status'    => 'inherit',
    'posts_per_page' => 1,
    'title'          => 'Sustainablejobs.com-banner-image-1',
]);
...
<div class="sj-banner">
    ...
    <div class="sj-banner__content">
        <div class="sj-banner__text">
            ...
            <h2 class="sj-banner__title">Create an account<br>on our platform.</h2>
            <p class="sj-banner__desc">The place where organizations, professionals and jobseekers in sustainability, energy transition and the impact world meet.</p>
        </div>
        <a href="https://platform.sustainablejobs.com/register" class="sj-banner__btn">
            Create Account
...
(function () {
    ...
    function insertMarketingBlocks(list) {
        ...
        // First block after 3 jobs, then every 7 jobs.
