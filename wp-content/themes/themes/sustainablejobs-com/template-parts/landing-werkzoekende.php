...
$intro           = has_excerpt($page_id) ? get_the_excerpt($page_id)              : 'Sustainablejobs.com is the dedicated job board for professionals who want to work for sustainable and socially engaged organizations.';
$primary_label   = get_post_meta($page_id, 'landing_primary_button_text', true)   ?: 'Create Profile';
$primary_url     = get_post_meta($page_id, 'landing_primary_button_url', true)    ?: 'https://platform.sustainablejobs.com/register-jobseeker';
$secondary_label = get_post_meta($page_id, 'landing_secondary_button_text', true) ?: 'Job Alert';
$secondary_url   = get_post_meta($page_id, 'landing_secondary_button_url', true)  ?: 'https://sustainablejobs.com/job-alerts/';
