...
$secondary_label = get_post_meta($page_id, 'landing_secondary_button_text', true) ?: 'Packages';
...
$contact_email   = get_post_meta($page_id, 'landing_email', true) ?: 'support@sustainablejobs.com';
?>
