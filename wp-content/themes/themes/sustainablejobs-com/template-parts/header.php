...
<header id="rn-header" class="rn-header" role="banner">
    <div class="rn-topbar">
        <div class="rn-topbar__inner">
            <div class="rn-topbar__left">
                <a href="mailto:support@sustainablejobs.com">support@sustainablejobs.com</a>
            ...
            <div class="rn-topbar__right">
                <a href="https://platform.sustainablejobs.com/register">Create Profile</a>
                <span class="rn-topbar__divider">|</span>
                <a href="https://platform.sustainablejobs.com/register">Employer Sign Up</a>
            </div>
        </div>
    </div>
    ...
    <div class="rn-header__inner">
        <div class="rn-header__brand">
            <a href="https://sustainablejobs.com">
        ...
        <div class="rn-header__cta">
            ...
            <a class="rn-mobile-icon-link rn-mobile-icon-link--account" href="https://platform.sustainablejobs.com/inloggen/" target="_blank" rel="noopener noreferrer" aria-label="My account">
            ...
            <a href="<?php echo esc_url(home_url('/post-a-job/')); ?>" class="rn-btn rn-btn--accent">Post a Job</a>
        </div>

        <div class="rn-header__mobile-left">
            <button class="rn-header__hamburger" aria-label="Open menu" aria-expanded="false" aria-controls="rn-mobile-nav">
                <span class="rn-hamburger__bar"></span>
                <span class="rn-hamburger__bar"></span>
                <span class="rn-hamburger__bar"></span>
            </button>

            <a class="rn-mobile-icon-link rn-mobile-icon-link--linkedin" href="https://www.linkedin.com/company/sustainable-jobs/" target="_blank" rel="noopener noreferrer" aria-label="Sustainable Jobs on LinkedIn">
        ...
        <div class="rn-header__mobile-right">
            <?php if (function_exists('sj_the_job_favorites_nav_link')) sj_the_job_favorites_nav_link('rn-header__favorite-link'); ?>
            <a class="rn-mobile-icon-link rn-mobile-icon-link--account" href="https://platform.sustainablejobs.com/register" aria-label="My account">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true"><path d="M12 12a5 5 0 1 0-5-5 5 5 0 0 0 5 5Zm0 2c-4.42 0-8 2.24-8 5v1a1 1 0 0 0 1 1h14a1 1 0 0 0 1-1v-1c0-2.76-3.58-5-8-5Z"/></svg>
            </a>
        </div>
    </div>
...
<div id="rn-mobile-nav" class="rn-mobile-nav" aria-hidden="true">
    <div class="rn-mobile-nav__panel">
        <button class="rn-mobile-nav__close" aria-label="Close menu">
        ...
        <div class="rn-mobile-nav__ctas">
            ...
            <a href="<?php echo esc_url(home_url('/post-a-job/')); ?>" class="rn-btn rn-btn--accent rn-mobile-nav__cta">Post a Job</a>
        </div>
    </div>
</div>
