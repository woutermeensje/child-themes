...
$intro           = has_excerpt($page_id) ? get_the_excerpt($page_id) : 'Discover jobs from leading sustainable and socially engaged employers. Organizations at the forefront of the transition to a better world.';
$primary_label   = get_post_meta($page_id, 'landing_primary_button_text', true)   ?: 'Create Profile';
$primary_url     = get_post_meta($page_id, 'landing_primary_button_url', true)    ?: 'https://platform.sustainablejobs.com/register';
