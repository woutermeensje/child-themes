...
$intro           = has_excerpt($page_id) ? get_the_excerpt($page_id) : 'Sustainablejobs.com is the dedicated job board for professionals looking to work in sustainability, energy transition, ecology, biodiversity, nature conservation, non-profits, government, municipalities and NGOs.';
