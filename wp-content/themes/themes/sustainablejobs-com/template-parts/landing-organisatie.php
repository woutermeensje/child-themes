...
$intro           = has_excerpt($page_id) ? get_the_excerpt($page_id)              : 'Sustainablejobs.com offers organizations the opportunity to post jobs, share news and publish sustainable initiatives for a broad audience of engaged professionals.';
...
$secondary_label = get_post_meta($page_id, 'landing_secondary_button_text', true) ?: 'Create Account';
$secondary_url   = get_post_meta($page_id, 'landing_secondary_button_url', true)  ?: 'https://platform.sustainablejobs.com/register/employer';
