...
function sj_info_aanvraag_shortcode(): string {
    ...
    if (
        ...
        if (!$bericht)         $errors[] = 'Please enter your message.';

        if (empty($errors)) {
            $admin_email = get_option('admin_email');
            $onderwerp   = 'New information request via Sustainablejobs.com';

            $body  = "New information request:\n\n";
            $body .= "Name:        {$voornaam} {$achternaam}\n";
            $body .= "Email:      {$email}\n";
            if ($telefoon) $body .= "Phone:    {$telefoon}\n";
            $body .= "\nMessage:\n{$bericht}";
        ...
        <?php else: ?>
            ...
            <div class="sj-ia__block">
                <header class="sj-ia__header">
                    <h2 class="sj-ia__title">Request information</h2>
                    <p class="sj-ia__subtitle">Fill in the form and we will contact you as soon as possible.</p>
                </header>
                ...
                <form method="post" class="sj-ia__form" novalidate>
                    ...
                    <div class="sj-ia__field">
                        <label class="sj-ia__label" for="ia_voornaam">First name <span class="sj-ia__req">*</span></label>
                    ...
                    <div class="sj-ia__field">
                        <label class="sj-ia__label" for="ia_achternaam">Last name <span class="sj-ia__req">*</span></label>
                    ...
                    <div class="sj-ia__field">
                        <label class="sj-ia__label" for="ia_email">Email address <span class="sj-ia__req">*</span></label>
                    ...
                    <div class="sj-ia__field">
                        <label class="sj-ia__label" for="ia_telefoon">Phone number</label>
                        <input type="tel" name="ia_telefoon" id="ia_telefoon" class="sj-ia__input"
                               value="<?php echo esc_attr($_POST['ia_telefoon'] ?? ''); ?>">
                    </div>

                    <div class="sj-ia__field">
                        <label class="sj-ia__label" for="ia_bericht">Message <span class="sj-ia__req">*</span></label>
                    ...
                    <button type="submit" class="sj-ia__submit">Send</button>
                </form>
            </div>
