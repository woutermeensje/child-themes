...
function sj_snel_plaatsen_shortcode(): string {
    ...
    if (
        ...
        if (empty($errors)) {
            ...
            $confirmation_body .= "Package: " . ($pakket ?: 'Quick post') . "\n";
            ...
            if ($post_id && !is_wp_error($post_id)) {
                ...
                update_post_meta($post_id, '_sj_pakket',       $pakket ?: 'Quick post');
                update_post_meta($post_id, '_sj_job_url', $url);
            }
    ...
    <div class="sj-vp">
        <div class="sj-vp__block">
            ...
            <header class="sj-vp__header">
                ...
                <p class="sj-vp__subtitle">Already familiar with our platform, or do you not want to fill in the full form? Just share the link to your job listing and we will take care of the rest.</p>
            </header>
                ...
                <div class="sj-vp__section">
                    <div class="sj-vp__grid sj-vp__grid--1">
                        ...
                        <div class="sj-vp__field">
                            <label class="sj-vp__label" for="sp_pakket">Package <span class="sj-vp__req">*</span></label>
                            <select name="sp_pakket" id="sp_pakket" class="sj-vp__input" required>
                                <option value="" disabled <?php selected($_POST['sp_pakket'] ?? '', ''); ?>>Choose a package...</option>
                                <option value="Standard Job: €275 excl. VAT"         <?php selected($_POST['sp_pakket'] ?? '', 'Standard Job: €275 excl. VAT'); ?>>Standard — €275.00 excl. VAT</option>
                                <option value="Spotlight Job: €375 excl. VAT"        <?php selected($_POST['sp_pakket'] ?? '', 'Spotlight Job: €375 excl. VAT'); ?>>Spotlight — €375.00 excl. VAT</option>
                                <option value="Internship & Volunteering: Free"           <?php selected($_POST['sp_pakket'] ?? '', 'Internship & Volunteering: Free'); ?>>Internship & Volunteering — Free</option>
                                <option value="We are a member of Sustainablejobs.com: Free" <?php selected($_POST['sp_pakket'] ?? '', 'We are a member of Sustainablejobs.com: Free'); ?>>We are a member — Free for members</option>
                                <option value="We have a credit bundle"                <?php selected($_POST['sp_pakket'] ?? '', 'We have a credit bundle'); ?>>Job bundle — Via credit bundle</option>
                            </select>
                        </div>

                        <div class="sj-vp__field">
                            <label class="sj-vp__label" for="sp_email">Email address <span class="sj-vp__req">*</span></label>
                        ...
                        <div class="sj-vp__field">
                            <label class="sj-vp__label" for="sp_url">Link to the job listing <span class="sj-vp__req">*</span></label>
