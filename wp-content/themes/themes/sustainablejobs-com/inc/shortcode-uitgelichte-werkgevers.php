...
/**
 * Shortcode: [sj_uitgelichte_employers]
 * Displays a three-column grid of featured employers.
 * Logo, name from alt text and description from image description.
 */
add_shortcode('sj_uitgelichte_employers', 'sj_uitgelichte_employers_shortcode');

function sj_uitgelichte_employers_shortcode(): string {
    global $wpdb;
