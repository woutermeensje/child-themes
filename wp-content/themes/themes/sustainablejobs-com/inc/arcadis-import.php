<?php
// Arcadis API import for sustainable jobs.
    ...
    foreach ($skills as $skill) {
        ...
        if (!empty($data['positions'])) {
            foreach ($data['positions'] as $job) {
                ...
                wp_update_post([
                    'ID' => $post_id,
                    'post_content' => 'View this job on the Arcadis website: ' . $job['canonicalPositionUrl']
                ]);
            }
        }
    }
...
// Admin page to manually import Arcadis jobs.
add_action('admin_menu', function () {
    add_menu_page(
        ...
        'import-arcadis',
        function () {
            echo '<div class="wrap"><h1>Import Arcadis Jobs</h1>';
