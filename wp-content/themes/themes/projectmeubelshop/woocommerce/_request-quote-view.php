		...
		<table class="shop_table cart  shop_table_responsive" id="yith-ywrq-table-list" cellspacing="0">
			<thead>
				<tr>
					...
					<th class="product-quantity"><?php esc_html_e('Aantal', 'yith-woocommerce-request-a-quote'); ?></th>
					<?php if (!$hide_price) : ?>
				...
				?>
					<tr>
						<td colspan="<?php echo esc_attr($colspan); ?>" class="actions">
							<input type="submit" class="button" name="update_raq" value="<?php echo esc_attr(get_option('ywraq_update_list_label', __('Update List', 'yith-woocommerce-request-a-quote'))); ?>">
