...
<div class="custom-top-section">
    <div class="top-section-text">
        <p>
            Blijf op de hoogte van de laatste opdrachten &amp; vacatures bij Studentinhuren.nl!
        </p>
        <div>
    ...
    <?php if ( $recent_jobs->have_posts() ) : ?>
      <section class="sj-recent sj-card">
        <div class="sj-recent-head">
          ...
          <p class="sj-recent-sub">Bekijk de nieuwste opdrachten en vacatures bij Studentinhuren.nl.</p>
        </div>
...
<style>
/* =========================================================
   Studentinhuren.nl – Single job modern styling
   ========================================================= */
