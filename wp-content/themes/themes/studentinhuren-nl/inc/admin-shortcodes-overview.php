...
/**
 * Admin overview for Studentinhuren.nl shortcodes.
 *
...
function si_render_shortcodes_overview_admin_page(): void {
    if (!current_user_can('edit_pages')) {
        wp_die(esc_html__('Je hebt geen rechten om deze pagina te bekijken.', 'Studentinhuren'));
    }

    ?>
    <div class="wrap si-shortcodes-overview">
        <h1>Studentinhuren shortcodes</h1>
        <p class="description">
            Overzicht van de shortcodes uit het Studentinhuren.nl child theme. Gebruik de kopieerknop om een shortcode snel in een pagina of blok te plakken.
        </p>
