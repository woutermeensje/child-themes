    ...
    <div class="mh-product-card__body mh-unit-card__body">
        ...
        <div class="mh-unit-card__footer">
            <div class="mh-unit-card__actions">
                <a class="mh-unit-card__cta" href="<?php the_permalink(); ?>">Bekijk unit</a>

                <?php if ($in_quote || $just_added): ?>
                    <a class="mh-unit-card__quote mh-unit-card__quote--added" href="<?php echo esc_url($quote_url); ?>">
                        Bekijk offerte
                    </a>
                <?php else: ?>
                    <form method="post" action="" class="mh-unit-card__quote-form">
                        ...
                        <button type="submit" class="mh-unit-card__quote">Toevoegen aan offerte</button>
                    </form>
                <?php endif; ?>
            </div>
