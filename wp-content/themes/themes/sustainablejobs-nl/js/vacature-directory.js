(function () {
    ...
    function buildSelect(directory, select, onChange) {
        ...
        clearButton.setAttribute('aria-label', 'Wis selectie');
        ...
        searchInput.placeholder = 'Zoek in ' + placeholder.toLowerCase();
    ...
    function renderActiveFilters(directory, searchInput, termSelects, applyFilters) {
        ...
        if (searchTerm) {
            ...
            chip.querySelector('.active-filter-text').textContent = 'Zoek: ' + searchTerm;
