...
/**
 * Shortcode: [sj_tarieven]
 * Toont drie tarievenblokken naast elkaar.
 */
add_shortcode('sj_tarieven', 'sj_tarieven_shortcode');

function sj_tarieven_shortcode(): string {
    ...
    $cards = [
        [
            ...
            'description' => 'Plaats een standaard vacature voor het vinden van een nieuwe collega!',
            'price'       => '€275,-',
            ...
            'features'    => [
                ...
                'Vermelding in job alerts (750+).',
            ],
        ],
        [
            'modifier'    => ' sj-tarieven__card--featured',
            'title'       => 'Spotlight Vacature',
            'description' => 'Maak optimaal gebruik en haal het maximale rendement uit jouw vacature plaatsing!',
            'price'       => '€375,-',
        ...
        [
            ...
            'title'       => 'Lidmaatschap',
            'description' => 'Een jaar lang alle voordelen van Sustainablejobs.nl (en Fondsen.org)!',
            'price'       => '€1.750,-',
            ...
            'features'    => [
                'Onbeperkt vacatures op Sustainablejobs.nl.',
                'Onbeperkt vacatures op Fondsen.org plaatsen.',
                'Uitgebreide bedrijfspagina.',
                'Vermelding als Uitgelichte Werkgever!',
                'Employer brand artikelen.',
                'Werken-bij interview.',
                'Backlinks op verschillende kanalen van Sustainablejobs.nl.',
            ],
        ],
    ];
