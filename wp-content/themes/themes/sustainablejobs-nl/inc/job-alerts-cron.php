...
function sj_send_weekly_job_alerts(): void {
    ...
    foreach ($subscribers as $subscriber) {
        ...
        $sent = wp_mail(
            $subscriber['email'],
            'Nieuwe vacatures in jouw vakgebied — Sustainablejobs.nl',
...
<head>
  ...
  <title>Job Alert — Sustainablejobs.nl</title>
</head>
...
add_action('init', function () {
    ...
    $message = $updated
        ? 'Je bent succesvol afgemeld voor job alerts van Sustainablejobs.nl.'
