...
require_once get_stylesheet_directory() . '/inc/job-application-submissions.php';
...
add_action('wp_enqueue_scripts', function () {
    ...
    if (file_exists(get_stylesheet_directory() . '/css/text.css')) {
        wp_enqueue_style(
            'sj-text',
            get_stylesheet_directory_uri() . '/css/text.css',
            ['child-style', 'poppins-font'],
            filemtime(get_stylesheet_directory() . '/css/text.css')
        );
    }
