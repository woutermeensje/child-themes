...
$intro           = has_excerpt($page_id) ? get_the_excerpt($page_id)              : 'Sustainablejobs.nl biedt organisaties de mogelijkheid om vacatures, nieuws en duurzame initiatieven te delen met een breed publiek van betrokken professionals.';
...
$secondary_url   = get_post_meta($page_id, 'landing_secondary_button_url', true)  ?: 'https://platform.sustainablejobs.nl/aanmelden/werkgever';
