...
function fondsen_vacature_plaatsen_shortcode(): string {
    ...
    if (
        ...
        if (empty($errors)) {
            ...
            $admin_body .= '<tr><td style="background:#0884CC;padding:28px 40px;"><h1 style="margin:0;color:#ffffff;font-size:22px;font-family:Arial,sans-serif;">Impact Vacatures</h1><p style="margin:6px 0 0;color:rgba(255,255,255,.85);font-size:14px;">Nieuwe vacature ontvangen</p></td></tr>';
            ...
            $admin_body .= '</td></tr>';
            $admin_body .= '<tr><td style="background:#f9f9f9;padding:20px 40px;text-align:center;font-size:12px;color:#999;">Impact Vacatures &mdash; <a href="mailto:informatie@impactvacatures.nl" style="color:#0884CC;">informatie@impactvacatures.nl</a></td></tr>';
            $admin_body .= '</table></td></tr></table></body></html>';

            wp_mail(
                'informatie@impactvacatures.nl',
            ...
            $conf_body .= '<tr><td style="background:#0884CC;padding:28px 40px;"><h1 style="margin:0;color:#ffffff;font-size:22px;font-family:Arial,sans-serif;">Impact Vacatures</h1><p style="margin:6px 0 0;color:rgba(255,255,255,.85);font-size:14px;">Vacaturesite en impact platform voor non-profits</p></td></tr>';
            ...
            $conf_body .= '<p style="margin:0 0 24px;font-size:15px;color:#333;line-height:1.6;">Bedankt voor het plaatsen van je vacature op <strong>Impact Vacatures</strong>. We hebben je inzending in goede orde ontvangen en ons team bekijkt deze zo snel mogelijk.</p>';
            ...
            $conf_body .= '<p style="margin:0;font-size:15px;color:#333;">Met vriendelijke groet,<br><strong>Team Impact Vacatures</strong></p>';
            $conf_body .= '</td></tr>';
            $conf_body .= '<tr><td style="background:#f9f9f9;padding:20px 40px;text-align:center;font-size:12px;color:#999;">Impact Vacatures &mdash; <a href="mailto:informatie@impactvacatures.nl" style="color:#0884CC;">informatie@impactvacatures.nl</a><br>Je ontvangt deze e-mail omdat je een vacature hebt geplaatst via impactvacatures.nl.</td></tr>';
            $conf_body .= '</table></td></tr></table></body></html>';

            wp_mail(
                $email,
                'Bevestiging van je vacatureplaatsing op Impact Vacatures',
                $conf_body,
                $html_headers
            );
    ...
    $pakketten = [
        ...
        'Wij zijn lid van Impact Vacatures'               => ['label' => 'Wij zijn lid', 'prijs' => 'Gratis'],
        ...
        <div class="sj-vp__block">
            ...
            <form method="post" class="sj-vp__form" enctype="multipart/form-data" novalidate>
                ...
                <div class="sj-vp__section">
                    ...
                    <p class="sj-vp__pakket-note">Vragen over pakketten of lidmaatschap? Mail naar <a href="mailto:informatie@impactvacatures.nl">informatie@impactvacatures.nl</a>.</p>
                </div>
                ...
                <footer class="sj-vp__footer">
                    ...
                    <p class="sj-vp__footer-note">Vragen? Mail naar <a href="mailto:informatie@impactvacatures.nl">informatie@impactvacatures.nl</a>.</p>
                </footer>
            </form>
        </div>
    </div>
