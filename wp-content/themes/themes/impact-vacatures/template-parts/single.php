<?php
/**
 * Single blogpost — Impact Vacatures child theme
 */
if ( ! defined( 'ABSPATH' ) ) {
    exit;
}
...
<?php
    ...
    $auteur    = get_post_meta( get_the_ID(), '_fn_artikel_auteur', true );
...
<main id="content" class="site-main fn-single-page">
<div class="fn-single__wrap">

    <!-- ── Artikel ─────────────────────────────────────── -->
    <article <?php post_class( 'fn-single__article' ); ?>>

        <?php if ( $cat_lbl ) : ?>
            <a href="<?php echo $cat_url; ?>" class="fn-single__cat"><?php echo $cat_lbl; ?></a>
        <?php endif; ?>

        <h1 class="fn-single__title"><?php the_title(); ?></h1>

        <div class="fn-single__meta">
            <?php if ( $auteur ) : ?>
                <span class="fn-single__auteur">
            ...
            <span class="fn-single__readtime">
        ...
        <?php if ( $thumb ) : ?>
            <div class="fn-single__hero-img">
                <?php echo $thumb; ?>
            </div>
        <?php endif; ?>

        <div class="fn-single__content">
            <?php the_content(); ?>
            <?php wp_link_pages(); ?>
        </div>

        <?php if ( has_tag() ) : ?>
            <div class="fn-single__tags">
                <?php the_tags( '', '' ); ?>
            </div>
        <?php endif; ?>

        <nav class="fn-single__nav" aria-label="Artikelnavigatie">
            <div class="fn-single__nav-prev">
                <?php previous_post_link( '%link', '&larr; %title' ); ?>
            </div>
            <div class="fn-single__nav-next">
    ...
    <!-- ── Sidebar ─────────────────────────────────────── -->
    <aside class="fn-single__sidebar">

        <div class="fn-single__recent">
            <h3 class="fn-single__recent-title">Recente artikelen</h3>
            <?php
            $recent = new WP_Query( [
                'post_type'      => 'post',
                'posts_per_page' => 6,
            ...
            ?>
            <a href="<?php the_permalink(); ?>" class="fn-recent__item">
                <div class="fn-recent__img-wrap">
                    <?php if ( $r_thumb ) : ?>
                        <?php echo str_replace( '<img ', '<img class="fn-recent__img" ', $r_thumb ); ?>
                    <?php else : ?>
                        <div class="fn-recent__img-placeholder">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="#FF8C2C" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="18" rx="2"/><path d="m3 9 4-4 4 4 4-4 4 4"/><circle cx="8.5" cy="14.5" r="1.5"/><path d="m21 15-5-5-5 5"/></svg>
                        </div>
                    <?php endif; ?>
                </div>
                <div class="fn-recent__body">
                    <?php if ( $r_cat ) : ?>
                        <span class="fn-recent__cat"><?php echo $r_cat; ?></span>
                    <?php endif; ?>
                    <h4 class="fn-recent__title"><?php the_title(); ?></h4>
                    <span class="fn-recent__date"><?php echo esc_html( $r_date ); ?></span>
                </div>
            </a>
            <?php
                endwhile;
        ...
        <div class="fn-sidebar-newsletter" style="margin-top:24px;">
