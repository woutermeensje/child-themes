...
$intro           = has_excerpt($page_id) ? get_the_excerpt($page_id)              : 'Impact Vacatures biedt non-profits de mogelijkheid in het plaatsen van nieuws en persberichten, vacatures en fondsenwerving oproepen.';
$primary_label   = get_post_meta($page_id, 'landing_primary_button_text', true)   ?: 'Oproep plaatsen';
$primary_url     = get_post_meta($page_id, 'landing_primary_button_url', true)    ?: 'https://platform.sustainablejobs.nl/';
$secondary_label = get_post_meta($page_id, 'landing_secondary_button_text', true) ?: 'Account aanmaken';
$secondary_url   = get_post_meta($page_id, 'landing_secondary_button_url', true)  ?: 'https://platform.sustainablejobs.nl/';
$contact_phone   = get_post_meta($page_id, 'landing_phone', true) ?: '085 239 2040';
$contact_email   = get_post_meta($page_id, 'landing_email', true) ?: 'informatie@impactvacatures.nl';
?>
    ...
    <section class="fnd-hero fnd-hero--non-profits">
        ...
        <div class="fnd-hero__left">
            ...
            <div class="fnd-hero__left-main">
                ...
                <h1 class="fnd-hero__title">Platform voor non-profits</h1>
