...
<form class="job_filters">
    ...
    <div class="filter-header" style="padding: 0 20px 10px 20px;">
        ...
        <p>Of schrijf je in voor de <a href="https://inhuren.com/updates/" target="_blank" class="unstyled-newsletter-link">automatische updates</a>!</p>
    </div>
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const buildSelect = (select) => {
    ...
    const renderState = () => {
      ...
      // MULTI: placeholder tonen (geen chips in de knop)
...
.job_filters {
  ...
  min-height: 220px;
  padding: 56px 0;
  background: var(--color-bg-filter, #f9f9f9);
  box-shadow: none;
  border: none;
