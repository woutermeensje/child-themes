...
function sj_ac_send_newsletter_campaign(array $vacatures): bool {
    ...
    $week_nr = date('W');
    $jaar    = date('Y');
    $subject = "De nieuwste online marketing vacatures van week {$week_nr} — Onlinemarketingjobs.nl";
    $html    = sj_build_newsletter_email_ac($vacatures);

    // 1. Message aanmaken
    $msg = sj_ac_request('POST', 'messages', [
        'message' => [
            'fromname'       => 'Onlinemarketingjobs.nl',
            'fromemail'      => 'support@onlinemarketingjobs.nl',
            'reply2'         => 'support@onlinemarketingjobs.nl',
            'subject'        => $subject,
            'preheader_text' => 'Bekijk de nieuwste online marketing vacatures van deze week.',
            'html'           => $html,
...
<head>
  ...
  <title>Vacaturenieuwsbrief week {$week_nr} — Onlinemarketingjobs.nl</title>
</head>
      ...
      <table width=\"600\" cellpadding=\"0\" cellspacing=\"0\" style=\"max-width:600px;width:100%;background:#ffffff;border-radius:8px;overflow:hidden;border:1px solid #dceae4;\">
        ...
        <tr>
          <td style=\"background:#7C5CFA;padding:24px 32px;\">
            <span style=\"font-family:Arial,sans-serif;font-size:20px;font-weight:700;color:#ffffff;\">Onlinemarketingjobs.nl</span>
        ...
        <tr>
          <td style=\"padding:28px 32px 8px;\">
            <p style=\"margin:0 0 10px;font-size:20px;font-weight:700;color:#7C5CFA;font-family:Arial,sans-serif;\">Hoi %FIRSTNAME%!</p>
            <p style=\"margin:0;font-size:15px;color:#444444;line-height:1.65;font-family:Arial,sans-serif;\">Dit zijn de nieuwste online marketing vacatures van deze week. Ontdek waar jij het verschil kunt maken.</p>
          </td>
        </tr>
        ...
        <tr>
          <td style=\"background:#f2f6f4;padding:20px 32px;text-align:center;\">
            <p style=\"margin:0 0 6px;font-size:12px;color:#999999;font-family:Arial,sans-serif;\">Je ontvangt deze nieuwsbrief omdat je je hebt aangemeld op Onlinemarketingjobs.nl.</p>
            <p style=\"margin:0;font-size:12px;font-family:Arial,sans-serif;\">
              <a href=\"%UNSUBSCRIBELINK%\" style=\"color:#7C5CFA;\">Afmelden voor de nieuwsbrief</a>
            </p>
          </td>
        </tr>
