...
function sj_nieuwsbrief_shortcode(): string {
    ...
    if (
        ...
        if (empty($errors)) {
            ...
            $admin_body  = "Nieuwe nieuwsbrief aanmelding op Onlinemarketingjobs.nl\n\n";
    ...
    <div class="sj-ja-notice sj-ja-notice--success">
        ...
        <div>
            ...
            <p>Je ontvangt elke week de nieuwste online marketing vacatures in je inbox.</p>
        </div>
    </div>
    ...
    <div class="sj-ja">
        <div class="sj-ja__block">
            <header class="sj-ja__header">
                ...
                <p class="sj-ja__subtitle">Ontvang elke week de nieuwste online marketing vacatures direct in je inbox.</p>
            </header>
