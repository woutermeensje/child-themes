...
/**
 * Shortcode: [omj_snel_plaatsen]
 * Snel een vacature plaatsen via e-mailadres + URL.
 */
add_shortcode('omj_snel_plaatsen', 'omj_snel_plaatsen_shortcode');

function omj_snel_plaatsen_shortcode(): string {
    ...
    if (
        ...
        isset($_POST['omj_sp_nonce']) &&
        wp_verify_nonce($_POST['omj_sp_nonce'], 'omj_snel_plaatsen')
    ) {
        ...
        if (empty($errors)) {
            ...
            $confirmation_body .= "Bedankt voor je vacature-aanvraag via Onlinemarketingjobs.nl.\n\n";
            ...
            $confirmation_body .= "Heb je vragen? Mail gerust naar support@onlinemarketingjobs.nl.\n\n";
            $confirmation_body .= "Met vriendelijke groet,\n";
            $confirmation_body .= "Onlinemarketingjobs.nl";

            wp_mail(
                $email,
                'Bevestiging van je vacature-aanvraag op Onlinemarketingjobs.nl',
                $confirmation_body,
                $headers
            );
    ...
    <div class="sj-vp">
        <div class="sj-vp__block">
            ...
            <header class="sj-vp__header">
                <h2 class="sj-vp__title">Vacature Plaatsen (Snel)</h2>
                <p class="sj-vp__subtitle">Ben je al bekend met onze organisatie? Deel dan alleen de link naar de vacature, dan doen wij de rest.</p>
            </header>

            <form method="post" class="sj-vp__form" novalidate>
                <?php wp_nonce_field('omj_snel_plaatsen', 'omj_sp_nonce'); ?>

                <div class="sj-vp__section">
                    <div class="sj-vp__grid sj-vp__grid--1">

                        <div class="sj-vp__field">
                            <label class="sj-vp__label" for="omj_sp_pakket">Pakket <span class="sj-vp__req">*</span></label>
                            <select name="sp_pakket" id="omj_sp_pakket" class="sj-vp__input" required>
                                ...
                                <option value="Wij zijn lid van Onlinemarketingjobs.nl: Gratis" <?php selected($_POST['sp_pakket'] ?? '', 'Wij zijn lid van Onlinemarketingjobs.nl: Gratis'); ?>>Wij zijn lid — Gratis voor leden</option>
                        ...
                        <div class="sj-vp__field">
                            <label class="sj-vp__label" for="omj_sp_email">E-mailadres <span class="sj-vp__req">*</span></label>
                            <input type="email" name="sp_email" id="omj_sp_email" class="sj-vp__input"
                                   value="<?php echo esc_attr($_POST['sp_email'] ?? ''); ?>"
                                   placeholder="jan@bedrijf.nl" required>
                        </div>

                        <div class="sj-vp__field">
                            <label class="sj-vp__label" for="omj_sp_url">Link naar de vacature <span class="sj-vp__req">*</span></label>
                            <input type="url" name="sp_url" id="omj_sp_url" class="sj-vp__input"
                ...
                <footer class="sj-vp__footer">
                    ...
                    <p class="sj-vp__footer-note">Nog makkelijker? Stuur de vacature gewoon per e-mail naar <a href="mailto:support@onlinemarketingjobs.nl">support@onlinemarketingjobs.nl</a>.</p>
                </footer>
