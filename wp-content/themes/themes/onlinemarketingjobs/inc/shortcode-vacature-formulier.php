...
/**
 * Shortcode: [omj_vacature_plaatsen]
 * Vacature-plaatsingsformulier met Quill rich text editor.
 */
add_shortcode('omj_vacature_plaatsen', 'omj_vacature_plaatsen_shortcode');

function omj_vacature_plaatsen_shortcode(): string {
    ...
    if (
        ...
        isset($_POST['omj_vp_nonce']) &&
        wp_verify_nonce($_POST['omj_vp_nonce'], 'omj_vacature_plaatsen')
    ) {
        ...
        if (empty($errors)) {
            ...
            $confirmation_body .= "Heb je in de tussentijd vragen? Reageer gerust op deze e-mail of mail naar support@onlinemarketingjobs.nl.\n\n";
            $confirmation_body .= "Met vriendelijke groet,\n";
            $confirmation_body .= "Onlinemarketingjobs.nl";

            wp_mail(
                $email,
                'Bevestiging van je vacatureplaatsing op Onlinemarketingjobs.nl',
                $confirmation_body,
                $headers
            );
    ...
    <div class="sj-vp">
        <div class="sj-vp__block">
            ...
            <form method="post" class="sj-vp__form" enctype="multipart/form-data" novalidate>
                <?php wp_nonce_field('omj_vacature_plaatsen', 'omj_vp_nonce'); ?>
                ...
                <div class="sj-vp__section">
                    ...
                    <div class="sj-vp__grid sj-vp__grid--2">
                        ...
                        $pakketten = [
                            ...
                            'Wij zijn lid van Onlinemarketingjobs.nl: Gratis' => ['label' => 'Wij zijn lid', 'prijs' => 'Gratis voor leden'],
                ...
                <div class="sj-vp__section">
                    ...
                    <div class="sj-vp__grid sj-vp__grid--2">
                        <div class="sj-vp__field">
                            <label class="sj-vp__label" for="omj_voornaam">Voornaam <span class="sj-vp__req">*</span></label>
                            <input type="text" name="voornaam" id="omj_voornaam" class="sj-vp__input"
                                   value="<?php echo esc_attr($_POST['voornaam'] ?? ''); ?>" required>
                        </div>
                        <div class="sj-vp__field">
                            <label class="sj-vp__label" for="omj_achternaam">Achternaam <span class="sj-vp__req">*</span></label>
                            <input type="text" name="achternaam" id="omj_achternaam" class="sj-vp__input"
                                   value="<?php echo esc_attr($_POST['achternaam'] ?? ''); ?>" required>
                        </div>
                        <div class="sj-vp__field">
                            <label class="sj-vp__label" for="omj_bedrijfsnaam">Bedrijfsnaam <span class="sj-vp__req">*</span></label>
                            <input type="text" name="bedrijfsnaam" id="omj_bedrijfsnaam" class="sj-vp__input"
                                   value="<?php echo esc_attr($_POST['bedrijfsnaam'] ?? ''); ?>" required>
                        </div>
                        <div class="sj-vp__field">
                            <label class="sj-vp__label" for="omj_email">E-mailadres <span class="sj-vp__req">*</span></label>
                            <input type="email" name="email" id="omj_email" class="sj-vp__input"
                ...
                <div class="sj-vp__section">
                    ...
                    <div class="sj-vp__grid sj-vp__grid--1">
                        ...
                        <div class="sj-vp__field">
                            <label class="sj-vp__label" for="omj_vacaturetitel">Vacaturetitel <span class="sj-vp__req">*</span></label>
                            <input type="text" name="vacaturetitel" id="omj_vacaturetitel" class="sj-vp__input"
                                   value="<?php echo esc_attr($_POST['vacaturetitel'] ?? ''); ?>" required>
                        </div>

                        <div class="sj-vp__field">
                            <label class="sj-vp__label" for="omj_locatie">Locatie</label>
                            <input type="text" name="locatie" id="omj_locatie" class="sj-vp__input"
                                   value="<?php echo esc_attr($_POST['locatie'] ?? ''); ?>">
                        </div>

                        <div class="sj-vp__field">
                            <label class="sj-vp__label" id="omj_type_baan_label">Type baan</label>
                            <?php
                            ...
                            <div class="sj-vp__ms" id="omj_type_baan_ms" aria-labelledby="omj_type_baan_label" role="group">
                        ...
                        <!-- Quill: omschrijving -->
                        <div class="sj-vp__field">
                            <label class="sj-vp__label" for="omj_omschrijving_hidden">Vacature omschrijving <span class="sj-vp__req">*</span></label>
                            <div class="sj-vp__quill-wrap">
                                <div id="omj_quill_omschrijving" class="sj-vp__quill-editor" style="min-height:220px;"></div>
                            </div>
                            <textarea name="omschrijving" id="omj_omschrijving_hidden" class="sj-vp__quill-hidden" aria-hidden="true"><?php echo esc_textarea($_POST['omschrijving'] ?? ''); ?></textarea>
                        ...
                        <div class="sj-vp__field">
                            <label class="sj-vp__label" for="omj_referral">Hoe heb je ons gevonden? <span class="sj-vp__opt">(optioneel)</span></label>
                            <input type="text" name="referral" id="omj_referral" class="sj-vp__input"
                                   value="<?php echo esc_attr($_POST['referral'] ?? ''); ?>"
                                   placeholder="Bijv. Google, LinkedIn, doorverwijzing...">
                        </div>
                ...
                <footer class="sj-vp__footer">
                    ...
                    <p class="sj-vp__footer-note">Je ontvangt een factuur per e-mail na publicatie. Vragen? Mail naar <a href="mailto:support@onlinemarketingjobs.nl">support@onlinemarketingjobs.nl</a>.</p>
                </footer>
    ...
    <div class="sj-vp-snel" id="omj-snel-balk">
        ...
        <button class="sj-vp-snel__close" aria-label="Sluiten" onclick="document.getElementById('omj-snel-balk').classList.add('is-hidden')">
    ...
    (function () {
        function initQuill() {
            ...
            var omschrijvingHidden = document.getElementById('omj_omschrijving_hidden');
            var quillOmschrijving  = new Quill('#omj_quill_omschrijving', {
                theme: 'snow',
        ...
        var ms          = document.getElementById('omj_type_baan_ms');
