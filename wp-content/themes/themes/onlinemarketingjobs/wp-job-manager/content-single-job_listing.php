...
<?php if ( $post_id && job_manager_user_can_view_job_listing( $post_id ) ) :
    ...
    $con_first = get_post_meta($post_id, '_job_contact_firstname', true) ?: get_post_meta($post_id, '_contact_first_name', true);
    $con_last  = get_post_meta($post_id, '_job_contact_lastname', true) ?: get_post_meta($post_id, '_contact_last_name', true);
    $con_email = get_post_meta($post_id, '_job_contact_email', true) ?: get_post_meta($post_id, '_contact_email', true);
    $support_email = 'support@onlinemarketingjobs.nl';
            ...
            <div class="single_job_listing">
                <?php if ( get_option( 'job_manager_hide_expired_content', 1 ) && 'expired' === $post->post_status ) : ?>
                    ...
                    <div class="sj-expired">
                        ...
                        <p class="sj-expired__intro">Helaas is deze vacature niet meer beschikbaar. Bekijk onze andere openstaande vacatures of stel een job alert in via de zijbalk.</p>
...
<div class="sj-vp-snel" id="sj-profiel-balk">
    ...
    <div class="sj-vp-snel__contact">
        <a href="<?php echo esc_url(home_url('/werkzoekende/')); ?>" class="sj-vp-snel__btn">Profiel aanmaken</a>
    </div>
...
.sj-sidebar__input:focus { border-color: #7C5CFA; }
...
.sj-vraag-req { color: var(--color-primary, #7C5CFA); margin-left: 2px; }
...
.sj-vraag-blok__input:focus {
    border-color: var(--color-primary, #7C5CFA) !important;
...
.sj-vraag-blok__quill-wrap .ql-toolbar button.ql-active { color: var(--color-primary, #7C5CFA) !important; }
.sj-vraag-blok__quill-wrap .ql-toolbar button:hover .ql-stroke,
.sj-vraag-blok__quill-wrap .ql-toolbar button.ql-active .ql-stroke { stroke: var(--color-primary, #7C5CFA) !important; }
.sj-vraag-blok__quill-wrap .ql-toolbar button:hover .ql-fill,
.sj-vraag-blok__quill-wrap .ql-toolbar button.ql-active .ql-fill { fill: var(--color-primary, #7C5CFA) !important; }
...
.sj-vraag-blok__upload {
    ...
    padding: 24px 20px;
    background: var(--color-bg-filter, #F3F7E4);
    border: 2px dashed var(--color-primary, #7C5CFA);
    border-radius: 5px;
    cursor: pointer;
    text-align: center;
    position: relative;
...
.sj-vraag-blok__upload:hover {
    border-color: var(--color-secondary, #b39cd0);
...
.sj-vraag-blok__submit {
    ...
    border: 2px solid var(--color-secondary, #b39cd0);
    color: var(--color-primary, #7C5CFA) !important;
    padding: 10px 28px;
    border-radius: 4px;
    cursor: pointer;
...
.sj-vraag-blok__submit:hover {
    background-color: var(--color-accent, #845ec2);
    border-color: var(--color-accent, #845ec2);
}
...
.sj-expired__all-link a:hover {
    color: var(--color-primary-hover, #845ec2);
    text-decoration: underline;
}
