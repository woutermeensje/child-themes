...
$eyebrow         = get_post_meta($page_id, 'landing_eyebrow', true)               ?: 'Voor bedrijven die online marketing talent zoeken';
$intro           = has_excerpt($page_id) ? get_the_excerpt($page_id)              : 'Onlinemarketingjobs.nl is dé vacaturesite voor online marketing professionals. Plaats jouw vacature en bereik direct de juiste kandidaten.';
...
$secondary_label = get_post_meta($page_id, 'landing_secondary_button_text', true) ?: 'Bekijk tarieven';
