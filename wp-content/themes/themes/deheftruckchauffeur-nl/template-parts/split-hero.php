...
$title_html = function_exists('deheftruckchauffeur_split_hero_highlight')
    ? deheftruckchauffeur_split_hero_highlight($title_raw, $accent_terms)
    : esc_html($title_raw);
...
$description_html = str_replace(
    ...
    '<a class="si-split-hero__description-link" style="' . esc_attr($description_link_style) . '" href="https://platform.deheftruckchauffeur.nl/" target="_blank" rel="noopener noreferrer">78 openstaande vacatures</a>',
    $description_html
);
$description_html = str_replace(
    'account',
    '<a class="si-split-hero__description-link" style="' . esc_attr($description_link_style) . '" href="https://platform.deheftruckchauffeur.nl/aanmelden" target="_blank" rel="noopener noreferrer">account</a>',
    $description_html
);
?>
