...
$contact_email  = get_post_meta($page_id, 'landing_email', true) ?: 'support@deheftruckchauffeur.nl';
?>
        ...
        <div class="fnd-hero__left">
            ...
            <div class="fnd-hero__left-main">
                ...
                <div class="fnd-hero__actions">
                    <a class="wz-btn--primary" href="https://platform.deheftruckchauffeur.nl/opdrachten/" target="_blank" rel="noopener" style="font-family: 'Work Sans', sans-serif !important; font-weight: 700 !important;">
                        Opdrachten bekijken
                    </a>
                    <a class="wz-btn--secondary" href="https://platform.deheftruckchauffeur.nl/aanmelden-werkzoekende" style="font-family: 'Work Sans', sans-serif !important; font-weight: 700 !important;">
                        Account aanmaken
                    </a>
                </div>
