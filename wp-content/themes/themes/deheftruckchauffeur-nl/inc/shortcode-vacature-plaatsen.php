        ...
        <div class="sj-vp__block">
            ...
            <form method="post" class="sj-vp__form" enctype="multipart/form-data" novalidate>
                ...
                <footer class="sj-vp__footer">
                    ...
                    <p class="sj-vp__footer-note">Je ontvangt een factuur per e-mail na publicatie. Vragen? Mail naar <a href="mailto:support@deheftruckchauffeur.nl">support@deheftruckchauffeur.nl</a>.</p>
                </footer>
            </form>
        </div>
    </div>
