    ...
    if (
        ...
        if (empty($errors)) {
            ...
            $body = si_build_admin_email(
                ...
                'Er is een nieuwe opdracht geplaatst via het formulier op deheftruckchauffeur.nl.',
                [
        ...
        <div class="sj-vp__block">
            ...
            <form method="post" class="si-op__form" novalidate>
                ...
                <footer class="sj-vp__footer">
                    ...
                    <p class="sj-vp__footer-note">Na je aanvraag nemen we contact met je op. Vragen? Mail naar <a href="mailto:support@deheftruckchauffeur.nl">support@deheftruckchauffeur.nl</a>.</p>
                </footer>
