...
/**
 * Admin overview for deheftruckchauffeur.nl shortcodes.
 *
...
add_action('admin_menu', function (): void {
    add_management_page(
        'deheftruckchauffeur.nl shortcodes',
        'deheftruckchauffeur.nl shortcodes',
        'edit_pages',
        'deheftruckchauffeur-shortcodes-overview',
...
function si_render_shortcodes_overview_admin_page(): void {
    if (!current_user_can('edit_pages')) {
        wp_die(esc_html__('Je hebt geen rechten om deze pagina te bekijken.', 'deheftruckchauffeur'));
    }

    ?>
    <div class="wrap si-shortcodes-overview">
        <h1>deheftruckchauffeur.nl shortcodes</h1>
        <p class="description">
            Overzicht van de shortcodes uit het deheftruckchauffeur.nl child theme. Gebruik de kopieerknop om een shortcode snel in een pagina of blok te plakken.
        </p>
