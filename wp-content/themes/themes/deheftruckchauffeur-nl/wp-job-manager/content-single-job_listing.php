...
<div class="custom-top-section">
    <div class="top-section-text">
        <p>
            Blijf op de hoogte van de laatste opdrachten &amp; vacatures bij deheftruckchauffeur.nl!
        </p>
        <div>
            <a href="<?php echo esc_url(home_url('/updates/')); ?>" class="top-section-link">Updates instellen</a>
        </div>
    </div>
</div>
    ...
    <div class="sj-card">
      ...
      <?php else : ?>
        ...
        $company_url  = $company_slug ? home_url( '/opdrachtgevers/' . $company_slug . '/' ) : '';
        ?>
    ...
    $cp = get_post_meta( get_the_ID(), '_contact_phone', true );

    $has_contact = ( ! empty($cf) || ! empty($cl) || ! empty($ce) || ! empty($cp) );
    ?>
    ...
    <?php if ( $has_contact ) : ?>
      <section class="sj-contact sj-card">
        ...
        <div class="sj-contact-grid">
          ...
          <?php if ( ! empty($cp) ) : ?>
            <div class="sj-contact-row">
              <span class="sj-contact-label">Telefoon</span>
              <a class="sj-contact-value sj-contact-link" href="tel:<?php echo esc_attr( preg_replace('/\s+/', '', $cp) ); ?>">
    ...
    <?php if ( $recent_jobs->have_posts() ) : ?>
      <section class="sj-recent sj-card">
        <div class="sj-recent-head">
          <h2 class="sj-recent-title">Recente opdrachten & vacatures</h2>
          <p class="sj-recent-sub">Bekijk de nieuwste opdrachten en vacatures bij deheftruckchauffeur.nl.</p>
        </div>
...
<style>
/* =========================================================
   deheftruckchauffeur.nl – Single job modern styling
   ========================================================= */
