...
add_filter('cron_schedules', function (array $schedules): array {
    if (!isset($schedules['fn_weekly'])) {
        $schedules['fn_weekly'] = [
            ...
            'display'  => 'Eén keer per week (Fondsen)',
        ];
    }
    return $schedules;
});
...
function fn_send_weekly_job_alerts(): void {
    ...
    foreach ($subscribers as $subscriber) {
        ...
        $sent = wp_mail(
            $subscriber['email'],
            'Nieuwe vacatures in jouw vakgebied — Fondsen.org',
...
<head>
  ...
  <title>Job Alert — Fondsen.org</title>
</head>
      ...
      <table width=\"600\" cellpadding=\"0\" cellspacing=\"0\" style=\"max-width:600px;width:100%;background:#ffffff;border-radius:8px;overflow:hidden;border:1px solid #E0E0E0;\">
        ...
        <tr>
          <td style=\"background:#f5f5f5;padding:20px 32px;text-align:center;\">
            <p style=\"margin:0 0 6px;font-size:12px;color:#999999;font-family:Arial,sans-serif;\">Je ontvangt deze mail omdat je een job alert hebt ingesteld op Fondsen.org.</p>
...
add_action('init', function () {
    ...
    $message = $updated
        ? 'Je bent succesvol afgemeld voor job alerts van Fondsen.org.'
