...
$intro           = has_excerpt($page_id) ? get_the_excerpt($page_id)              : 'Fondsen.org biedt non-profits de mogelijkheid in het plaatsen van nieuws en persberichten, vacatures en fondsenwerving oproepen.';
