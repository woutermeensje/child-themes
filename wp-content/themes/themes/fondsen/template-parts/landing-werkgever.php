...
$eyebrow         = get_post_meta($page_id, 'landing_eyebrow', true)               ?: 'Voor organisaties met een missie';
$intro           = has_excerpt($page_id) ? get_the_excerpt($page_id)              : 'Fondsen.org is dé vacaturesite voor professionals die willen werken bij non-profits, ngo\'s, stichtingen, verenigingen en social enterprises.';
...
$secondary_url   = get_post_meta($page_id, 'landing_secondary_button_url', true)  ?: 'https://platform.fondsen.org/registreren';
        ...
        <div class="fnd-hero__left">
            ...
            <div class="fnd-hero__left-main">
                ...
                <?php if ($text_link_label && $text_link_url) : ?>
                    <a class="fnd-hero__text-link" href="<?php echo esc_url($text_link_url); ?>">
