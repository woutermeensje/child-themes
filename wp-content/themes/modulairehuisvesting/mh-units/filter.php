    ...
    <div class="mh-catalog-sidebar-inner mh-units-catalog__sidebar-inner" style="position:sticky;top:20px;background:#fff;border:1px solid #DEDEDE;border-radius:5px;padding:20px;box-sizing:border-box;">
        <form class="mh-units-filter-form" method="get">
            ...
            <div class="mh-catalog-block mh-units-catalog__filter-block" style="padding-bottom:16px;margin-bottom:16px;border-bottom:1px solid #EBEBEB;">
                <label class="mh-units-filter-label" for="mh_search" style="display:block;margin:0 0 8px;color:var(--color-text, #333);font-family:'Poppins',sans-serif;font-size:14px;font-weight:700;line-height:1.3;">Zoek</label>
                <input
                    id="mh_search"
                    name="mh_search"
                    type="text"
            ...
            <div class="mh-catalog-block mh-catalog-block--actions mh-units-catalog__actions" style="padding-bottom:0;margin-bottom:0;border-bottom:none;display:flex;flex-direction:column;align-items:stretch;gap:12px;">
                <button type="submit" class="mh-units-catalog__submit" style="appearance:none;display:inline-flex;align-items:center;justify-content:center;width:100%;min-height:42px;padding:10px 18px;border:1px solid var(--color-secondary, #4188AA);border-radius:5px;background:linear-gradient(135deg, var(--color-secondary, #4188AA) 0%, var(--color-secondary, #4188AA) 100%);color:#fff;font-family:'Poppins',sans-serif;font-size:14px;font-weight:700;line-height:1;cursor:pointer;box-sizing:border-box;">Filters toepassen</button>
                <a class="mh-units-catalog__reset" href="<?php echo esc_url(get_permalink()); ?>" style="display:inline-flex;align-items:center;justify-content:center;width:100%;min-height:42px;padding:10px 18px;border:1px solid #DEDEDE;border-radius:5px;background:#fff;color:var(--color-text-soft, #333);font-family:'Poppins',sans-serif;font-size:14px;font-weight:700;line-height:1;text-decoration:none;box-sizing:border-box;">Filters wissen</a>
            </div>
        </form>
    </div>
</aside>
