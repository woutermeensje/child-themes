...
function mh_quote_render_page() {
	...
	.mh-qp__empty a:hover { background: var(--color-secondary, #4188AA); }
	...
	.mh-qp__btn--primary:hover { background: var(--color-secondary, #4188AA); border-color: var(--color-secondary, #4188AA); color: #fff; }
	.mh-qp__btn--outline {
		background: #fff;
		color: var(--color-primary, #25476B);
	...
	.mh-qp__textarea:focus {
		outline: none;
		border-color: var(--color-secondary, #4188AA);
